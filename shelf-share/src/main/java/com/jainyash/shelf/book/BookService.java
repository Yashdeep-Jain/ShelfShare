...
import com.jainyash.shelf.file.FileStorageService;
import com.jainyash.shelf.history.BookTransactionHistory;
import com.jainyash.shelf.history.BookTransactionHistoryRepository;
...
import static com.jainyash.shelf.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer updateShareableStatus(Integer bookId, Authentication connectedUser) {
        ...
        if (!book.getOwner().getId().equals(user.getId())) {
            throw new OperationNotPermittedException("You cannot update shareable status of this book");
        }
    ...
    public Integer updateArchivedStatus(Integer bookId, Authentication connectedUser) {
        ...
        User user = (User) connectedUser.getPrincipal();
        if (!book.getOwner().getId().equals(user.getId())) {
            throw new OperationNotPermittedException("You cannot update archived status of this book");
        }
